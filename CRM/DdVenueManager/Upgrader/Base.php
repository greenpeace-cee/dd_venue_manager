 ...
 */
class CRM_DdVenueManager_Upgrader_Base {

  /**
   * @var CRM_DdVenueManager_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_DdVenueManager_Upgrader(
        'dd_venue_manager',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_DdVenueManager_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_DdVenueManager_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
